          ...
          <div className="col-lg-5 col-md-5 col-12">
            <div className="d-flex justify-content-around align-items-center">
              ...
              <div>
                ...
                <p className="text-white">9868 Forest Avenue Pompano Beach, FL 33060</p>
              </div>
            </div>
            ...
            <div className="d-flex justify-content-around align-items-center">
              ...
              <div>
                ...
                <p className="text-white">1800 123 18000 , 1800 123 18000 ,1800 123 18000</p>
              </div>
            </div>
            ...
            <div className="d-flex justify-content-around align-items-center">
              ...
              <div>
                ...
                <p className="text-white">1800 123 1800,1800 123 1800,1800 123 18001 </p>
              </div>
            </div>
            ...
            <div className="d-flex justify-content-around align-items-center">
              ...
              <div>
                <h5 className="text-white">Fax</h5>
                <p className="text-white">Programmerjahid1@gmail,com bdcar@gmail.com </p>
              </div>
            </div>
          </div>
          <div className="col-lg-5 col-md-5 col-12">
